        ...
        <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
            <a href="" class="text-decoration-none">
                <h1 class="mb-4 display-5 font-weight-semi-bold"><span
                        class="text-primary font-weight-bold border border-white px-3 mr-1">Park</span>FOOD BAR</h1>
            </a>
            <p>Beergarden, Wineshop & Bistro.</p>
            <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>Jalan Soekarno Hatta No.3, Jambi City</p>
            <p class="mb-2"><i class="fa fa-envelope text-primary mr-3"></i>ParkFoodBar@gmail.com</p>
            <p class="mb-0"><i class="fa fa-phone-alt text-primary mr-3"></i>+62 082185350369</p>
        </div>
    ...
    {{--  <div class="row border-top border-light mx-xl-5 py-4">
        <div class="col-md-6 px-xl-0">
            <p class="mb-md-0 text-center text-md-left text-dark">
                ...
                Distributed By <a href="https://themewagon.com" target="_blank">ARMOKO</a>
            </p>
        </div>
